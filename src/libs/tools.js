...
export const formatDate = (_date, fmt) => {
	var o = {
		"M+": _date.getMonth() + 1,
		"d+": _date.getDate(),
		"h+": _date.getHours(),
 ...
 * 整合url和param参数
 * **********************/
export const parse = function (url, param) {
	...
	return host ? (host = host[0],
		...
		search = search && "" != search ? queryToJson(linkArr[1], !0) : {},
		$.extend(search, param), [url, jsonToQuery(search, !0)].join("?") + host
}
export const getParam = function (url, t) {
	var param = url.split("?");
	return queryToJson(param[1] || "", !0)[t]
}
...
const queryToJson = function (e, t) {
	var n = e.trim().split("&"),
		i = {},
		r = function (e, t) {
...
const jsonToQuery = function (e, t) {
	var n = function (e, t) {
