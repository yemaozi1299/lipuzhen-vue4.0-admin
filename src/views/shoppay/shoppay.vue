...
<div style="position:relative;margin:0 10px 10px 10px;">
    ...
    <div style="margin-right: 10px; line-height: 55px;"><h2>支付方式</h2></div>
    <Form ref="formValidate" :model="formValidate" :rules="ruleValidate" :label-width="150">
        <Form-item label="收款方名称" prop="name">
            <Input v-model="formValidate.name" placeholder="请输入收款方名称"></Input>
        </Form-item>
        <Form-item label="小程序AppID" prop="wxappid">
            <Input v-model="formValidate.wxappid" placeholder="小程序AppID"></Input>
        </Form-item>
        <Form-item label="小程序AppSecret" prop="appsecret">
            <Input v-model="formValidate.appsecret" placeholder="请输入小程序AppSecret"></Input>
        </Form-item>
        <Form-item label="微信支付商户号[MCHID]" prop="mchid">
            <Input v-model="formValidate.mchid" placeholder="请输入微信支付商户号"></Input>
        </Form-item>
        <Form-item label="商户支付密钥[key]" prop="partner_key">
            <Input v-model="formValidate.partner_key" placeholder="请输入商户支付密钥"></Input>
        </Form-item>
...
<script>
    export default {
        ...
        methods: {   
        	get:function() {//获取新闻内容
				var _this = this;
        	    var apiurl="/move/api_edit.php?action=goods_payGet&appid="+this.vueAppid;
