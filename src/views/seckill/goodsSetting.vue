                ...
                <div class="container">
                    ...
                    >
                        ...
                        >
                            ...
                            <FormItem
                                label="商品设置"
                                v-if="data.guigehave == 0"
                            >
                                <div class="seckill-price">
                                    <span>秒杀价格 </span
                                    ><Input
                                        type="number"
                                        @on-change="limitSeckillPrice"
                                        v-model="formItem.seckill_price"
                                        style="width: 80px"
                                        :disabled="isDisabled"
                                    ></Input
                                    ><span> 元</span>
                                ...
                                <div>
                                    ...
                                    ><Input
                                        type="number"
                                        @on-change="limitSeckillkc"
                                        v-model="formItem.seckill_kc"
                                        style="width: 80px"
                                        :disabled="isDisabled"
                                    ></Input
                                    ><span> 件</span>
                                    <span class="stock">库存{{ data.kc }}</span>
                                </div>
                                <p class="seckill-tips">
                                    注：秒杀商品数量不能大于商品库存
                                </p>
                            </FormItem>
                            ...
                            <FormItem label="购买限制">
                                <div>
                                    <span>单人单秒杀时间段内最高可购买</span
                                    ><Input
                                        type="number"
                                        v-model="formItem.seckill_buy_limit"
                                        style="width: 60px"
                                        :disabled="isDisabled"
                                    ></Input
                                    >件
