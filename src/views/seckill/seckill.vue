...
<Card class="seckill_controller_member">
  <header class="top">
    ...
    <router-link :to="{path: '/seckill/add'}">
      <Button type="primary" icon="md-add" class="ant-btn">新建秒杀商品</Button>
    </router-link>
    <!-- <Button type="primary" icon="md-add" class="ant-btn">新建用户</Button>
    <Button type="primary" ghost  class="ant-btn">回收站</Button>--></header>
  <main class="main">
    <div class="left">
    ...
    <div class="right">
      ...
      <div class="page-wrap">
        <Row>
          <Col span="2" style="text-algin:left"></Col>
          <Col span="22">
            <Page v-if="total >= 10" :total="total" :current="page" :page-size="pageno" show-total show-elevator @on-change="skippage"></Page>
          </Col>
        </Row>
      </div>
    </div>
